        ...
        <div className="flex flex-wrap">
          <div className="w-5/6 sm:w-1/2 p-6">
            ...
            <p className="text-gray-600 mb-8 text-lg">
              ...
              18 years old or older with a valid driver’s license, and then
              you're ready to go!
              <br />
            </p>
          </div>
        ...
        <div className="flex flex-wrap flex-col-reverse sm:flex-row">
          ...
          <div className="w-full sm:w-1/2 p-6 mt-6">
            <div className="align-middle">
              ...
              <p className="text-gray-600 mb-8 text-lg">
                Vehicle Network gives you access to all kinds of vehicles for
                your needs, including SUVs for a family road trip, pickup
                trucks, and classic sports cars for a night out.
                <br />
              </p>
            </div>
          </div>
